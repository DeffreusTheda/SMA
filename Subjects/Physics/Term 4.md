...
1. **First Law: Elliptical Orbits**<br>
...
**1. b. $T^2 = \frac{4 \pi^2 r^2}{G M}$<br>**
      $r^2 = \frac{T^2 G M}{4 \pi^2}$<br>
      $r^2 = \frac{84600^2 \cdot 6.674 \cdot 10^{-11} \cdot 6.0 \cdot 10^24}{4 \pi^2}$<br>
      $r^2 = 29.03878447 s N m^2 kg^{-1}$<br>
			$r = 5.388764652 = 5.39$<br>
			$r = 4.23 \cdot 10^7$<br>
			$h = r - R$
	 c. GPS
...
2. b. Calculate Hubble's speed.<br>
      $\frac{m v^2}{r} = \frac{G M m}{r^2}$<br>
      $v^2 = \frac{G M}{r}$<br>
      $v^2 = \frac{6.674 \cdot 10^{-11} \cdot 6.0 \cdot 10^24}{560000}$<br>
			$v = 5.3481639 \cdot 10^{-7} = 5.4 \cdot 10^{-7}$
	 c. In a servicing mission, a space shuttle spotted the Hubble telescope a distance of 10 km ahead. Estimate how long it took the shuttle to catch up with Hubble, assuming that the shuttle was moving in a circular orbit just 500 m below Hubble orbit.<br>
      $v_s^2 = \frac{6.674 \cdot 10^{-11} \cdot 6.0 \cdot 10^24}{559500}$<br>
			$v_s = 5.35055308 \cdot 10^{-7} = 5.4 \cdot 10^{-7}$<br>
			$v_h - v_s = 2.38917318 \cdot 10^{-10} km s^{-1}$<br>
